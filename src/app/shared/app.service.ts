...
export class AppService implements App {
    ...
    buildMeta() {
        ...
        this.metaService.addTags([
            ...
            { itemprop: "name", content: `${this.config.page.description ? this.config.page.description : this.config.app.description}` },
            { itemprop: "description", content: `${this.config.page.description ? this.config.page.description : this.config.app.description}` },
